...
Image::Image(BaseEngine* pEngine, int iWidth, int iHeight, bool useTopLeftFor00, int objX, int objY, std::string path, std::string title) : DisplayableObject(pEngine, iWidth, iHeight, useTopLeftFor00) {
